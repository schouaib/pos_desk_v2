...
export default function Categories({ path }) {
  ...
  function closeAllDialogs() {
    closeModal('cat-modal'); closeModal('cat-delete-modal')
    setDeleteTarget(null)
  }

  function openCreate() {
    closeAllDialogs(); setEditing(null); setForm({ name: '' }); setError(''); openModal('cat-modal')
  }

  function openEdit(item) {
    closeAllDialogs(); setEditing(item); setForm({ name: item.name }); setError(''); openModal('cat-modal')
  }
        ...
        <div class="overflow-x-auto">
          <table class="table table-sm w-full">
            <thead class="bg-base-200/60">
              <tr>
                <th class="px-3 py-2.5 text-xs font-semibold uppercase tracking-wide text-base-content/70">{t('categoryName')}</th>
                      ...
                      <div class="flex gap-1">
                        ...
                        {canDelete && (
                          <div class="tooltip tooltip-left" data-tip={t('delete')}>
                            <button class="btn btn-sm btn-ghost btn-square text-error" onClick={() => { closeAllDialogs(); setDeleteTarget(item); openModal('cat-delete-modal') }}>
                              <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
