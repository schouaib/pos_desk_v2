...
import { saToken, clearSaAuth } from './auth'

function token() {
  return saToken.value
}

// Reuse activation headers from main app
let _machineId = ''
let _activationKey = ''
export function setSaActivationHeaders(machineId, key) {
...
export const saApi = {
  ...
  changePassword: (body) => request('POST', '/super-admin/change-password', body),
