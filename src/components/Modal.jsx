...
export function Modal({ id, title, children, size }) {
  const boxClass = size === '2xl' ? 'modal-box w-full sm:max-w-4xl max-h-[85vh] overflow-y-auto p-5'
    : size === 'xl' ? 'modal-box w-full sm:max-w-2xl max-h-[80vh] overflow-y-auto p-4'
