...
const emptyFeatures = { products: false, purchases: false, suppliers: false, sales: false, pos: false, losses: false, expenses: false, retraits: false, stats: false, multi_barcodes: false, product_history: false, clients: false, client_payments: false, user_summary: false, multi_folders: false, access_management: false, favorites: false, product_variants: false, stock_transfers: false, product_discounts: false, product_bundles: false, batch_tracking: false, scale: false }
...
<body>
  ...
  <div class="footer">
    ...
    let iframe = document.getElementById('plan-print-frame')
    if (!iframe) {
        ...
        <div class="overflow-x-auto overflow-y-auto max-h-[calc(100vh-280px)]">
          <table class="table table-sm w-full">
            <thead class="bg-base-200/60">
              <tr>
                {[t('name'), t('priceDa'), t('maxUsers'), t('maxProducts'), t('maxSalesMonth'), t('planFeatures'), t('status'), t('actions')].map((h, i) => (
