...
export default function Setup() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      await api.setup({ name: form.name, email: form.email, password: form.password, cf_token })
      const data = await api.login({ email: form.email, password: form.password, cf_token })
